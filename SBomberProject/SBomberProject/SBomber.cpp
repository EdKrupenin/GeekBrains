    ...
    score(0)
{
    ...
    const uint16_t maxX = FileLoggerSingletone::GetInstance().GetMaxX();
    const uint16_t maxY = FileLoggerSingletone::GetInstance().GetMaxY();
...
void SBomber::DrawFrame()
{
    ...
    FileLoggerSingletone::GetInstance().GotoXY(0, 0);
    fps++;
